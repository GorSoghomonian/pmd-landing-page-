...
export default function IndustriesPage() {
  return (
    <main>
      ...
      {/* Real Estate Section */}
      <section className="bg-blue-700 text-white py-20 px-6 md:px-20 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div>
          ...
          <h2 className="text-4xl font-bold mb-4">Real Estate</h2>
          <p className="text-lg mb-6 leading-relaxed">
            We transform property management and sales processes through advanced CRM systems and automated workflows.
          ...
          <button className="bg-white text-blue-700 font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition-all">
            See Case Study →
          </button>
        </div>

        {/* Картинка через next/image */}
        <div className="relative w-full lg:w-[600px] h-96 overflow-hidden rounded-2xl shadow-lg">
          <Image
            src="https://readdy.ai/api/search-image?query=real%20estate%20night%20city&width=600&height=400&seq=industry-real-estate&orientation=landscape"
